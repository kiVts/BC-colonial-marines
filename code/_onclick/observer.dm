...
/mob/dead/observer/verb/toggle_inquisition() // warning: unexpected inquisition
	...
	if(client.inquisitive_ghost)
		to_chat(src, "<span style='color:#0000FF'>You will now examine everything you click on.</span>")
	else
		to_chat(src, "<span style='color:#0000FF'>You will no longer examine things you click on.</span>")
