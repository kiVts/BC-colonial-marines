...
/mob/living/carbon/human/RestrainedClickOn(var/atom/A) //chewing your handcuffs
	...
	if (last_chew + 75 > world.time)
		to_chat(H, "<span style='color:#FF0000'>You can't bite your hand again yet...</span>")
		return
	...
	var/s = "<span style='color:#FF0000'>[H.name] chews on \his [O.display_name]!</span>"
	H.visible_message(s, "<span style='color:#FF0000'>You chew on your [O.display_name]!</span>")
