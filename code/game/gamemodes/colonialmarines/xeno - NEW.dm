...
/datum/game_mode/proc/transform_player2(mob/living/carbon/human/H)
	...
	to_chat(H.client, "<span style='color:#0000FF'>You were a crew member on the Nostromo. Your crew was wiped out by an alien infestation. You should try to locate and help other survivors (If there are any other than you.)</span>")
	return 1
...
/datum/game_mode/infestation/declare_completion()
	if(finished == 1)
		...
		to_chat(world, "<span style='color:#FF0000'><FONT size = 3><B>The aliens have successfully wiped out the marines and will live to spread the infestation!</B></FONT></span>")
		if(prob(50))
		...
		to_chat(world, "<span style='color:#FF0000'><FONT size = 3><B>The marines managed to wipe out the aliens and stop the infestation!</B></FONT></span>")
		if(prob(50))
		...
		to_chat(world, "<span style='color:#FF0000'><FONT size = 3><B>Both the marines and the aliens have been terminated. At least the infestation has been erradicated!</B></FONT></span>")
		...
		to_chat(world, "<span style='color:#FF0000'><FONT size = 3><B>The station has been evacuated... but the infestation remains!</B></FONT></span>")
		...
		to_chat(world, "<span style='color:#FF0000'><FONT size = 3><B>The station has blown by a nuclear fission device... there are no winners!</B></FONT></span>")
