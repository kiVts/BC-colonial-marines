...
/datum/game_mode/Halloween/announce()
	to_chat(world, "<B>The current game mode is - Colonial Marines Halloween! SpooOOOoooky!!!</B>")
...
//Give them proper jobs and stuff here later
	...
	spawn(4)
		...
		to_chat(H, "<span style='color:#0000FF'>You are a survivor of the attack on LV-624. You worked or lived in the archaeology colony, and managed to avoid the alien attacks.. until now.</span>")
