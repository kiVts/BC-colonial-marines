...
/datum/game_mode/announce()
	to_chat(world, "<B>The current game mode is - Heavy Role-Playing!</B>")
	to_chat(world, "<B>Psssss... Shhhhhhhh!</B>")
	var/musical_track = pick('sound/theme/horror-metall_forextendermode.ogg','sound/theme/water_horror.ogg')
