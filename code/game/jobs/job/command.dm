...
/datum/job/command/ares
	...
	flags_whitelist = WHITELIST_ARES
...
/datum/job/command/advisor
	title = "Senior Enlisted Advisor"
	comm_title = "SEA"
	paygrade = "E9"
	flag = ROLE_HIGHT_COMMANDING_OFFICER
	supervisors = "USCM very high command"
	idtype = /obj/item/card/id/gold
	flags_startup_parameters = ROLE_ADD_TO_DEFAULT|ROLE_ADD_TO_MODE|ROLE_ADMIN_NOTIFY|ROLE_WHITELISTED
	flags_whitelist = WHITELIST_ADVISOR
	skills_type = /datum/skills/senior_enlisted_advisor

	generate_wearable_equipment()
		. = list(
				WEAR_EAR = /obj/item/device/radio/headset/almayer/mcom,
				WEAR_BODY = /obj/item/clothing/under/marine/officer/admiral,
				WEAR_FEET = /obj/item/clothing/shoes/centcom,
				...
				WEAR_HEAD = /obj/item/clothing/head/admiral,
				WEAR_JACKET = /obj/item/clothing/suit/armor/vest/admiral,
				WEAR_IN_BACK = /obj/item/clothing/mask/breath,
				WEAR_IN_BACK = /obj/item/storage/box/handcuffs,
				WEAR_R_STORE = /obj/item/storage/pouch/general/large,
				WEAR_L_STORE = /obj/item/storage/pouch/magazine/pistol/pmc_mateba,
				WEAR_IN_BACK = /obj/item/ammo_magazine/revolver/mateba,
				WEAR_IN_BACK = /obj/item/explosive/grenade/phosphorus,
				WEAR_IN_BACK = /obj/item/explosive/grenade/flashbang,
				WEAR_IN_BACK = /obj/item/clothing/suit/storage/marine/MP/admiral,
				WEAR_IN_BACK = /obj/item/handcuffs,
				WEAR_IN_BACK = /obj/item/handcuffs
				)
	generate_stored_equipment()
		. = list(
...
You are also in line to take command after the executive officer."}
...
//Vehicle Crewmen //For now, straight up copied from the pilot officers until their role is more solidified
/datum/job/command/vehicle_crew
	title = "Vehicle Crewman"
	comm_title = "VC"
	paygrade = "O1"
	flag = ROLE_VEHICLE_OFFICER
	total_positions = 4
	spawn_positions = 4
	minimal_player_age = 120
	...
	flags_startup_parameters = ROLE_ADD_TO_DEFAULT|ROLE_ADD_TO_MODE//|ROLE_ADMIN_NOTIFY|ROLE_WHITELISTED
//	flags_whitelist = WHITELIST_VEHICLE_CREW
	skills_type = /datum/skills/vehicle_crew
