...
/obj/machinery/recharge_station/verb/move_inside()
	...
	if (!(istype(usr, /mob/living/silicon/)))
		to_chat(usr, "<span style='color:#0000FF'><B>Only non-organics may enter the recharger!</B></span>")
		return
	if (src.occupant)
		to_chat(usr, "<span style='color:#0000FF'><B>The cell is already occupied!</B></span>")
		return
	if (!usr:cell)
		to_chat(usr, "<span style='color:#0000FF'>Without a powercell, you can't be recharged.</span>")
