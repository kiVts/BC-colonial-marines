...
/obj/machinery/telecomms/receiver/preset
	...
	freq_listening = list(COMM_FREQ, JTAC_FREQ, ENG_FREQ, SEC_FREQ, MED_FREQ, CIV_GEN_FREQ, CIV_COMM_FREQ, SUP_FREQ)
...
/obj/machinery/telecomms/bus/preset_three
	id = "Bus 3"
	network = "tcommsat"
	freq_listening = list(SEC_FREQ, COMM_FREQ, JTAC_FREQ)
...
/obj/machinery/telecomms/server/presets/command
	id = "Command Server"
	freq_listening = list(COMM_FREQ, JTAC_FREQ)
