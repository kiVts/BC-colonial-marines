...
/obj/machinery/optable/attack_paw(mob/user as mob)
	if ((HULK in usr.mutations))
		to_chat(usr, text("<span style='color:#0000FF'>You destroy the operating table.</span>"))
		visible_message("<span style='color:#FF0000'>[usr] destroys the operating table!</span>")
		src.density = 0
		cdel(src)
...
/obj/machinery/optable/attack_hand(mob/living/user)
	if (HULK in usr.mutations)
		to_chat(usr, text("<span style='color:#0000FF'>You destroy the table.</span>"))
		visible_message("<span style='color:#FF0000'>[usr] destroys the operating table!</span>")
		src.density = 0
		cdel(src)
		return
...
/obj/machinery/optable/proc/check_table(mob/living/carbon/patient as mob)
	if(victim)
		to_chat(usr, "<span style='color:#0000FF'><B>The table is already occupied!</B></span>")
		return 0

	if(patient.buckled)
		to_chat(usr, "<span style='color:#0000FF'><B>Unbuckle first!</B></span>")
		return 0
