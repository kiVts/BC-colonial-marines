...
/obj/machinery/autolathe/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(!filltype)
		to_chat(user, "<span style='color:#FF0000'>\The [src] is full. Please remove material from the autolathe in order to insert more.</span>")
		return
	else if(filltype == 1)
...
/obj/machinery/autolathe/Topic(href, href_list)
	...
	if(busy)
		to_chat(usr, "<span style='color:#FF0000'>The autolathe is busy. Please wait for completion of previous operation.</span>")
		return
