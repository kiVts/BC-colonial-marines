...
/obj/machinery/bot/attack_animal(var/mob/living/simple_animal/M as mob)
	...
	visible_message("<span style='color:#FF0000'><B>[M] has [M.attacktext] [src]!</B></span>")
	...
	if(istype(W, /obj/item/tool/screwdriver))
		...
		if(health < maxhealth)
			if(open)
				...
				user.visible_message("<span style='color:#FF0000'>[user] repairs [src]!","<span style='color:#0000FF'>You repair [src]!</span></span>")
			else
