...
/obj/machinery/portable_atmospherics/powered/scrubber/huge/attack_hand(var/mob/user as mob)
		to_chat(usr, "<span style='color:#0000FF'>You can't directly interact with this machine. Use the scrubber control console.</span>")
...
/obj/machinery/portable_atmospherics/powered/scrubber/huge/attackby(var/obj/item/I as obj, var/mob/user as mob)
	if(istype(I, /obj/item/tool/wrench))
		if(on)
			to_chat(user, "<span style='color:#0000FF'>Turn it off first!</span>")
			return

		anchored = !anchored
		playsound(src.loc, 'sound/items/Ratchet.ogg', 25, 1)
		to_chat(user, "<span style='color:#0000FF'>You [anchored ? "wrench" : "unwrench"] \the [src].</span>")
...
/obj/machinery/portable_atmospherics/powered/scrubber/huge/stationary/attackby(var/obj/item/I as obj, var/mob/user as mob)
	if(istype(I, /obj/item/tool/wrench))
		to_chat(user, "<span style='color:#0000FF'>The bolts are too tight for you to unscrew!</span>")
		return
