...
#define MARINE_CAN_BUY_ALL			65535 //65536
...
/obj/machinery/marine_selector/Topic(href, href_list)
	...
	if (in_range(src, usr) && isturf(loc) && ishuman(usr))
		...
		if (href_list["vend"])
			...
			if(bitf == MARINE_CAN_BUY_KIT)
				if(vendor_role == "Squad Marine" && H.mind && H.mind.assigned_role == "Squad Marine")
					var/p_name = L[1]
					switch(p_name)
						if("Combat Technician Support Kit")
							H.mind.cm_skills.engineer = SKILL_ENGINEER_METAL
							H.mind.cm_skills.construction = SKILL_CONSTRUCTION_METAL
						if("First Response Medical Support Kit")
							H.mind.cm_skills.surgery = SKILL_SURGERY_TRAINED
							H.mind.cm_skills.medical = SKILL_MEDICAL_DOCTOR
						else
							to_chat(H, "<span class='warning'><b>Вы ничего не смогли нового изучить в описании этого кита, плохой вкус или авторы.</b></span>")
							return
					H.update_action_buttons()
...
/obj/machinery/marine_selector/clothes
	...
	listed_products = list(
							...
							list("Armor Light", 0, /obj/item/clothing/suit/storage/marine/l, MARINE_CAN_BUY_ARMOR, "white"),
							list("Armor Medium", 0, /obj/item/clothing/suit/storage/marine, MARINE_CAN_BUY_ARMOR, "white"),
							list("Armor Heavy", 0, /obj/item/clothing/suit/storage/marine/h, MARINE_CAN_BUY_ARMOR, "white"),
							...
							list("Construction pouch (materials included)", 0, /obj/item/storage/pouch/construction/full_pfc, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							...
							list("KITS (choose 1)", 0, null, null, null),
							list("Combat Technician Support Kit", 0, /obj/item/storage/box/cts_kit, MARINE_CAN_BUY_KIT, "orange"),
							list("First Response Medical Support Kit", 0, /obj/item/storage/box/mini_med_kit, MARINE_CAN_BUY_KIT, "white"),
							list("L42 Sniper Kit", 0, /obj/item/storage/box/sniper_kit, MARINE_CAN_BUY_KIT, "white"),
							list("Veteran Kit", 0, /obj/item/storage/box/veteran_kit, MARINE_CAN_BUY_KIT, "white"),
							list("Personal Defense Kit", 0, /obj/item/storage/box/defense_kit, MARINE_CAN_BUY_KIT, "white"),
							list("M240 Pyrotechnician Support Kit", 0, /obj/item/storage/box/Pyrotechnician_kit, MARINE_CAN_BUY_KIT, "white"),
							list("Frontline M40 Grenadier kit", 0, /obj/item/storage/box/grenadier_kit, MARINE_CAN_BUY_KIT, "white"),
...
/obj/machinery/marine_selector/clothes/specialist
	...
	listed_products = list(
							...
							list("POUCHES (choose 2)", 0, null, null, null),
							//list("Rockets pouch", 0, /obj/item/storage/pouch/rpg, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							list("Shotgun shell pouch", 0, /obj/item/storage/pouch/shotgun, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
...
//							list("Smoke grenade", 2, /obj/item/explosive/grenade/smokebomb, null, "black"),
							list("Incendiary chem grenade (Blue)", 4, /obj/item/explosive/grenade/incchem, null, "black"),
