		...
		switch(buildstage)
			if(2)
				if (istype(W, /obj/item/device/multitool))
					...
					if (src.detecting)
						user.visible_message("<span style='color:#FF0000'>[user] has reconnected [src]'s detecting unit!", "You have reconnected [src]'s detecting unit.</span>")
					else
						user.visible_message("<span style='color:#FF0000'>[user] has disconnected [src]'s detecting unit!", "You have disconnected [src]'s detecting unit.</span>")
				else if (istype(W, /obj/item/tool/wirecutters))
					user.visible_message("<span style='color:#FF0000'>[user] has cut the wires inside \the [src]!", "You have cut the wires inside \the [src].</span>")
...
/obj/machinery/firealarm/attack_hand(mob/user as mob)
	...
	if (istype(user, /mob/living/carbon/human) || istype(user, /mob/living/silicon))
		...
		var/dat = "<HTML><HEAD></HEAD><BODY><TT><B>Fire alarm</B> [d1]\n<HR>The current alert level is: [get_security_level()]; The current DEFCON Level is: ?</b><br><br>\nTimer System: [d2]<BR>\nTime Left: [(minute ? "[minute]:" : null)][second] <A href='?src=\ref[src];tp=-30'>-</A> <A href='?src=\ref[src];tp=-1'>-</A> <A href='?src=\ref[src];tp=1'>+</A> <A href='?src=\ref[src];tp=30'>+</A>\n</TT></BODY></HTML>"
		...
		var/second = round(src.time) % 60
		var/minute = (round(src.time) - second) / 60
		var/dat = "<HTML><HEAD></HEAD><BODY><TT><B>[stars("Fire alarm")]</B> [d1]\n<HR><b>The current alert level is: [stars(get_security_level())]; The current DEFCON Level is: ?</b><br><br>\nTimer System: [d2]<BR>\nTime Left: [(minute ? text("[]:", minute) : null)][second] <A href='?src=\ref[src];tp=-30'>-</A> <A href='?src=\ref[src];tp=-1'>-</A> <A href='?src=\ref[src];tp=1'>+</A> <A href='?src=\ref[src];tp=30'>+</A>\n</TT></BODY></HTML>"
		user << browse(dat, "window=firealarm")
		onclose(user, "firealarm")
	return
