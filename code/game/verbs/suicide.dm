...
/mob/living/carbon/human/verb/suicide()
	...
	if(confirm == "Yes")
		...
		viewers(src) << pick("<span style='color:#FF0000'><b>[src] is attempting to bite \his tongue off! It looks like \he's trying to commit suicide.</b></span>", \
							"<span style='color:#FF0000'><b>[src] is jamming \his thumbs into \his eye sockets! It looks like \he's trying to commit suicide.</b></span>", \
							"<span style='color:#FF0000'><b>[src] is twisting \his own neck! It looks like \he's trying to commit suicide.</b></span>", \
							"<span style='color:#FF0000'><b>[src] is holding \his breath! It looks like \he's trying to commit suicide.</b></span>")
		adjustOxyLoss(max(175 - getToxLoss() - getFireLoss() - getBruteLoss() - getOxyLoss(), 0))
		updatehealth()
...
/mob/living/brain/verb/suicide()
	...
	if(confirm == "Yes")
		suiciding = 1
		viewers(loc) << "<span style='color:#FF0000'><b>[src]'s brain is growing dull and lifeless. It looks like it's lost the will to live.</b></span>"
		spawn(50)
			death(0)
			suiciding = 0
...
/mob/living/carbon/monkey/verb/suicide()
	...
	if(confirm == "Yes")
		...
		viewers(src) << "<span style='color:#FF0000'><b>[src] is attempting to bite \his tongue. It looks like \he's trying to commit suicide.</b></span>"
		adjustOxyLoss(max(175- getToxLoss() - getFireLoss() - getBruteLoss() - getOxyLoss(), 0))
		updatehealth()
...
/mob/living/silicon/ai/verb/suicide()
	...
	if(confirm == "Yes")
		suiciding = 1
		viewers(src) << "<span style='color:#FF0000'><b>[src] is powering down. It looks like \he's trying to commit suicide.</b></span>"
		//put em at -175
