...
/obj/structure/sink/attack_hand(mob/user)
	...
	if(busy)
		to_chat(user, "<span style='color:#FF0000'>Someone's already washing here.</span>")
		return

	to_chat(usr, "<span style='color:#0000FF'>You start washing your hands.</span>")
	...
	for(var/mob/V in viewers(src, null))
		V.show_message("<span style='color:#0000FF'>[user] washes their hands using \the [src].</span>")
...
/obj/structure/sink/attackby(obj/item/O as obj, mob/user as mob)
	...
	if (istype(RG) && RG.is_open_container())
		...
		user.visible_message("<span style='color:#0000FF'>[user] fills \the [RG] using \the [src].","\blue You fill \the [RG] using \the [src].</span>")
		return
	...
	to_chat(usr, "<span style='color:#0000FF'>You start washing \the [I].</span>")
	...
	O.clean_blood()
	user.visible_message( \
		"<span style='color:#0000FF'>[user] washes \a [I] using \the [src].</span>", \
		"<span style='color:#0000FF'>You wash \a [I] using \the [src].</span>")
