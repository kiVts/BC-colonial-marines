...
/obj/item/inflatable/attack_self(mob/user)
	...
	to_chat(user, "<span style='color:#0000FF'>You inflate [src].</span>")
...
/obj/structure/inflatable/attackby(obj/item/W as obj, mob/user as mob)
	...
	if (can_puncture(W))
		visible_message("<span style='color:#FF0000'><b>[user] pierces [src] with [W]!</b></span>")
		deflate(1)
...
/obj/structure/inflatable/proc/deflate(var/violent=0)
	...
	if(violent)
		...
		//to_chat(user, "<span style='color:#0000FF'>You slowly deflate the inflatable wall.</span>")
