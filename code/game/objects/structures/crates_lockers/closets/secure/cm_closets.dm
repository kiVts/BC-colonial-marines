...
/obj/structure/closet/secure_closet/advisor
	name = "SEA's locker"
	req_access = list(ACCESS_MARINE_COMMANDER)
	icon_state = "secure_locked_commander"
	icon_closed = "secure_unlocked_commander"
	...
	New()
		..()
		new /obj/item/storage/backpack/mcommander(src)
		new /obj/item/clothing/under/marine/officer/admiral(src)
		new /obj/item/clothing/shoes/centcom(src)
		new /obj/item/clothing/gloves/black(src)
		new /obj/item/device/radio/headset/almayer/mcom(src)
		new /obj/item/storage/backpack/lightpack(src)
		new /obj/item/clothing/head/admiral(src)
		new /obj/item/clothing/suit/armor/vest/admiral(src)
		new /obj/item/clothing/mask/breath(src)
		new /obj/item/storage/box/handcuffs(src)
		new /obj/item/explosive/grenade/phosphorus(src)
		new /obj/item/explosive/grenade/flashbang(src)
		new /obj/item/clothing/suit/storage/marine/MP/admiral(src)
