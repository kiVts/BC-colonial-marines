...
/obj/structure/decalm_sign
	name = "Secret Research Facility landing sign"
	desc = "A large sign that reads 'Secret Research Facility', with half the sign written in Russian.."
	icon = 'icons/obj/landing_signs.dmi'
	icon_state = "decalm_sign"
	bound_width = 64
	density = 1

/obj/structure/fact_sign
	name = "Secret Research Facility landing sign"
	desc = "A large sign that reads 'Secret Research Facility', with half the sign written in Russian.."
	icon = 'icons/obj/landing_signs.dmi'
	icon_state = "fact_sign"
	bound_width = 64
	density = 1

/obj/structure/sec_sign
	name = "Secret Research Complex landing sign"
	desc = "A large sign that reads 'Secret Research Complex', with half the sign written in Russian.."
	icon = 'icons/obj/landing_signs.dmi'
	icon_state = "sec_sign"
	bound_width = 64
	density = 1