...
/obj/structure/window_frame/attackby(obj/item/W, mob/living/user)
	if(istype(W, /obj/item/tool/weldingtool))
		...
		if(WT.remove_fuel(0, user))
			...
			to_chat(user, "<span style='color:#0000FF'>Now unwelding the metal from the window frame</span>")
			if(do_after(user, 40, TRUE, 5, BUSY_ICON_BUILD))
				to_chat(user, "<span style='color:#0000FF'>You unwelded metal from the window frame</span>")
	...
	if(istype(W, /obj/item/tool/wrench) && welded == 0)
		...
		to_chat(user, "<span style='color:#0000FF'>Now disassembling window frame</span>")
		if(do_after(user, 40, TRUE, 5, BUSY_ICON_BUILD))
			to_chat(user, "<span style='color:#0000FF'>You disassembled window frame!</span>")
...
/obj/structure/window_frame/deadwood
	icon_state = "demb0_frame"
	basestate = "demb"

/obj/structure/window_frame/deadwood/z
	icon_state = "zdemb0_frame"
	basestate = "zdemb"
