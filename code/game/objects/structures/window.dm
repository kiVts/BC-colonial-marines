...
/obj/structure/window/framed/deadwood
	name = "reinforced window"
	icon_state = "demb0"
	basestate = "demb"
	desc = "A glass window with a special rod matrice inside a wall frame. It looks rather strong. Might take a few good hits to shatter it."
	health = 100
	reinf = TRUE
	window_frame = /obj/structure/window_frame/deadwood



/obj/structure/window/framed/deadwood/z
	name = "reinforced window"
	icon_state = "zdemb0"
	basestate = "zdemb"
	desc = "A glass window with a special rod matrice inside a wall frame. It looks rather strong. Might take a few good hits to shatter it."
	health = 100
	reinf = TRUE
	window_frame = /obj/structure/window_frame/deadwood/z
