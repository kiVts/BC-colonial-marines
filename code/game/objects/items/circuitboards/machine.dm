...
/obj/item/circuitboard/machine/unary_atmos/attackby(obj/item/I as obj, mob/user as mob)
	if(istype(I,/obj/item/tool/screwdriver))
		...
		user.visible_message("<span style='color:#0000FF'>\The [user] adjusts the jumper on the [src]'s port configuration pins.", "\blue You adjust the jumper on the port configuration pins. Now set to [dir2text(machine_dir)].</span>")
	return
