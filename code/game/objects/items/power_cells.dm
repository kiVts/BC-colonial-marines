/obj/item/cell
	...
	suicide_act(mob/user)
		viewers(user) << "<span style='color:#FF0000'><b>[user] is licking the electrodes of the [src.name]! It looks like \he's trying to commit suicide.</b></span>"
		return (FIRELOSS)

/obj/item/cell/crap
	name = "Yutani brand rechargable AA battery"
