...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
	...
	null, \
	new/datum/stack_recipe("barbed wire", /obj/item/stack/barbed_wire, 2, 1, 20, time = 10, one_per_turf = 0, skill_req = SKILL_CONSTRUCTION_METAL), \
...
/*	new/datum/stack_recipe("razor wire assembly", /obj/item/stack/razorwire, 2, 1, 20, time = 10, one_per_turf = 0,, skill_req = SKILL_CONSTRUCTION_METAL), \*/
