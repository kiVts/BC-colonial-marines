...
/obj/item/device/radio/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 86794326)
	else
...
/obj/item/device/radio/examine(mob/user)
	...
	if ((in_range(src, user) || loc == user))
		if (b_stat)
			to_chat(user, "<span style='color:#0000FF'>[src] can be attached and modified!</span>")
		else
			to_chat(user, "<span style='color:#0000FF'>[src] can not be modified or attached!</span>")
...
/obj/item/device/radio/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(!istype(src, /obj/item/device/radio/beacon))
		if (b_stat)
			user.show_message("<span style='color:#0000FF'>The radio can now be attached and modified!</span>")
		else
			user.show_message("<span style='color:#0000FF'>The radio can no longer be modified or attached!</span>")
		updateDialog()
			//Foreach goto(83)
