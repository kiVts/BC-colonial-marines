...
/obj/item/storage/belt/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 798921)
	else
...
/obj/item/storage/belt/marine
	...
	can_hold = list(
		...
		"/obj/item/ammo_magazine/handful",
		"/obj/item/ammo_magazine/carabin",
...
/obj/item/storage/belt/marine/full_rifle_mk1/New()
	..()
...
/obj/item/storage/belt/marine/full_lmg/New()
	..()
...
/obj/item/storage/belt/marine/full_carabin/New()
	..()
	new /obj/item/ammo_magazine/carabin(src)
	new /obj/item/ammo_magazine/carabin(src)
	new /obj/item/ammo_magazine/carabin(src)
	new /obj/item/ammo_magazine/carabin(src)
	new /obj/item/ammo_magazine/carabin(src)
...
/obj/item/storage/sparepouch/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/storage/belt/gun/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/storage/belt/gun/m82f
	name = "M276 pattern M82F flare gun holster rig"
	desc = "The M276 pattern M82F is the standard load-bearing flare special of the USCM. It consists of a modular belt with various clips. This version is for the Flare Gun."
	icon_state = "flare_holster"
	item_state = "cmateba_holster"
	max_w_class = 17
	storage_slots = 30
	can_hold = list(
		"/obj/item/weapon/gun/flare",
		"/obj/item/device/flashlight/s_flare",
		"/obj/item/device/flashlight/flare"
		)
	New()
		..()
...
/obj/item/storage/belt/gun/m82f/full/New()
	..()
...
/obj/item/storage/belt/gun/su6h
...
/obj/item/storage/belt/gun/su6h/full/New()
	..()
	var/obj/item/weapon/gun/new_gun = new /obj/item/weapon/gun/pistol/smart(src)
	new /obj/item/ammo_magazine/smart(src)
	new /obj/item/ammo_magazine/smart(src)
	new /obj/item/ammo_magazine/smart(src)
	new /obj/item/ammo_magazine/smart(src)
	new_gun.on_enter_storage(src)
...
/obj/item/storage/belt/gun/smartgun
	name = "M802 Pattern Smartgunner Rig"
	...
	icon_state = "smart_holster"
	item_state = "s6_holster"
	max_w_class =16
	storage_slots = 40
	max_storage_space = 28
	can_hold = list(
...
/obj/item/storage/belt/gun/smartgun/full/New()
	..()
	var/obj/item/weapon/gun/new_gun = new /obj/item/weapon/gun/pistol/smart(src)
	var/obj/item/weapon/gun/new_drum = new /obj/item/smartgun_powerpack(src)
	var/obj/item/weapon/gun/new_drum2 = new /obj/item/smartgun_powerpack(src)
	new /obj/item/ammo_magazine/smart(src)
	new /obj/item/ammo_magazine/smart(src)
	new_gun.on_enter_storage(src)
	new_drum.on_enter_storage(src)
	new_drum2.on_enter_storage(src)
