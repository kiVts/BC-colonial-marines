...
/obj/item/storage/pouch/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/storage/pouch/magazine/large/mar_carabing/New()
	..()
	new /obj/item/ammo_magazine/carabin/ap (src)
	new /obj/item/ammo_magazine/carabin/ap (src)
	new /obj/item/ammo_magazine/carabin/ap (src)

/obj/item/storage/pouch/magazine/marcarabin/New()
	..()
	new /obj/item/ammo_magazine/carabin/ap (src)
	new /obj/item/ammo_magazine/carabin/ap (src)
...
/obj/item/storage/pouch/pyro
	name = " Pyro pouch"
	desc = "This pouch can contain up to 2 incinerator tank for M240(T)(A1) incinerator unit."
	icon_state = "pyro"
	storage_slots = 2
	max_w_class = 3
	can_hold = list(
					"/obj/item/ammo_magazine/flamer_tank/large",
					"/obj/item/ammo_magazine/flamer_tank/largeg",
					"/obj/item/ammo_magazine/flamer_tank/large/B",
					"/obj/item/ammo_magazine/flamer_tank/large/X",
					"/obj/item/ammo_magazine/flamer_tank"
					)

/obj/item/storage/pouch/pyro/full/New()
	..()
	new /obj/item/ammo_magazine/flamer_tank/largeg(src)
	new /obj/item/ammo_magazine/flamer_tank/largeg(src)

/obj/item/storage/pouch/pyro/full_bx/New()
	..()
...
/obj/item/storage/pouch/respon_med
	name = "First Responder Technical Pouch"
	desc = "It can contain small medical supplies."
	icon_state = "medicalrespons"
	storage_slots = 4
...
/obj/item/storage/pouch/respon_med/full/New()
	..()
	new /obj/item/device/healthanalyzer(src)
	new /obj/item/stack/medical/splint(src)
...
/obj/item/storage/pouch/flare/full/New()
	...
	new /obj/item/device/flashlight/flare(src)
/*
/obj/item/storage/pouch/s_flare
	name = "flare pouch"
	desc = "A packet of eight M89-S Signal Marking Flares. Used for signaling close air support dropships to strafe an area."
	max_w_class = 2
	storage_slots = 20
	draw_mode = 1
	icon_state = "s_flare"
	can_hold = list("/obj/item/device/flashlight/s_flare")

/obj/item/storage/pouch/s_flare/attackby(obj/item/W, mob/user)
	if(istype(W, /obj/item/storage/box/m89))
		var/obj/item/storage/box/m89/M = W
		if(M.contents.len)
			if(contents.len < storage_slots)
				to_chat(user, "<span class='notice'>You start refilling [src] with [M].</span>")
				if(!do_after(user, 15, TRUE, 5, BUSY_ICON_GENERIC)) return
		...
		return ..()
/obj/item/storage/pouch/s_flare/full/New()
	..()
	new /obj/item/device/flashlight/s_flare(src)
	new /obj/item/device/flashlight/s_flare(src)
	new /obj/item/device/flashlight/s_flare(src)
	new /obj/item/device/flashlight/s_flare(src)
	new /obj/item/device/flashlight/s_flare(src)
...
/obj/item/storage/pouch/construction/full_pfc/New()
	..()
	new /obj/item/stack/sandbags_empty/half (src)
