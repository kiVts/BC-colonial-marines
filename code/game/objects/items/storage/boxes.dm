...
/obj/item/storage/box/m89/update_icon()
	if(!contents.len)
		icon_state = "m89_e"
	else
		icon_state = "m89"
...
/obj/item/storage/box/nade_box3
	name = "M40 HPDP grenade box"
	desc = "A secure box holding 25 M40 HPDP grenades. But powerful phosphorus grenade, don't store near the flamer fuel."
	icon_state = "nade3_placeholder"
	w_class = 4
	storage_slots = 25
	max_storage_space = 50
	can_hold = list("/obj/item/explosive/grenade/phosphorus")
	var/nade_box_icon
	var/grenade_type = /obj/item/explosive/grenade/phosphorus

/obj/item/storage/box/nade_box3/New()
	..()
	select_gamemode_skin(/obj/item/storage/box/nade_box3)
	nade_box_icon = icon_state
	for(var/i = 1 to storage_slots)
		new grenade_type(src)

/obj/item/storage/box/nade_box3/update_icon()
	if(!contents.len)
		icon_state = "[nade_box_icon]_e"
	else
		icon_state = nade_box_icon
...
/obj/item/storage/box/nade_box2
	name = "M40 HIDP grenade box"
	desc = "A secure box holding 25 M40 HIDP grenades. But powerful phosphorus grenade, don't store near the flamer fuel."
	icon_state = "nade2_placeholder"
	w_class = 4
	storage_slots = 25
	max_storage_space = 50
	can_hold = list("/obj/item/explosive/grenade/incendiary")
	var/nade_box_icon
	var/grenade_type = /obj/item/explosive/grenade/incendiary

/obj/item/storage/box/nade_box2/New()
	..()
	select_gamemode_skin(/obj/item/storage/box/nade_box2)
	nade_box_icon = icon_state
	for(var/i = 1 to storage_slots)
		new grenade_type(src)

/obj/item/storage/box/nade_box2/update_icon()
	if(!contents.len)
		icon_state = "[nade_box_icon]_e"
	else
		icon_state = nade_box_icon
