...
/obj/item/book/manual/tank_manual
	...
	dat = {"<html>
				...
				<h1><a name="Foreword"><U><B>HOW TO BE A GOOD VEHICLE CREW</B></U></a></h1><BR>
				<I>Or: What All These "M"'s mean?</I><BR><BR>

				This Technical Manual supposed to help rookie Vehicle Crew members (VC from here) to get the basics of M46
				...
				<li><B>4. At high cost.</B> If it's clear to you that you are not getting out of this alive, take as many with you as you can. Vehicle Crewmans are usually killed on sight.</li>
