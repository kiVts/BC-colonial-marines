...
/obj/item/m_gift/attack_self(mob/M as mob)
	...
	if(fancy > 95)
		if(exFancy == 1)
			to_chat(M, "<span style='color:#0000FF'>It's a brand new, un-restricted, THERMOBARIC ROCKET LAUNCHER!!!!!!  What are the chances???</span>")
			...
			to_chat(M, "<span style='color:#0000FF'>It's a brand new, un-restricted, ANTI-MATERIAL SNIPER RIFLE!!!!!!  What are the chances???</span>")
			...
			to_chat(M, "<span style='color:#0000FF'>Just what the fuck is it???</span>")
			...
			to_chat(M, "<span style='color:#0000FF'>It's a REAL gift!!!</span>")
			var/obj/item/I = new gift_type(M)
			M.temp_drop_inv_item(src)
			M.put_in_hands(I)
			I.add_fingerprint(M)
		...
		to_chat(M, "<span style='color:#0000FF'>It's fucking EMPTY.  Man, Fuck CM.</span>")
		M.temp_drop_inv_item(src)
		cdel(src)
		return
	...
	to_chat(M, "<span style='color:#0000FF'>At least it's something...</span>")
	var/obj/item/I = new gift_type(M)
	M.temp_drop_inv_item(src)
	M.put_in_hands(I)
	I.add_fingerprint(M)
