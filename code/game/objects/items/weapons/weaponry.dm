...
/obj/item/weapon/banhammer
	...
	suicide_act(mob/user)
		viewers(user) << "<span style='color:#FF0000'><b>[user] is hitting \himself with the [src.name]! It looks like \he's trying to ban \himself from life.</b></span>"
...
/obj/item/weapon/nullrod
	...
	suicide_act(mob/user)
		viewers(user) << "<span style='color:#FF0000'><b>[user] is impaling \himself with the [src.name]! It looks like \he's trying to commit suicide.</b></span>"
