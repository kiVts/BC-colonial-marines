...
#define BE_CHANGELING 32768

#define BE_WO_COM 65536
//=================================================
...
#define ROLE_HIGHT_COMMANDING_OFFICER	2
#define ROLE_EXECUTIVE_OFFICER			4
#define ROLE_BRIDGE_OFFICER				8
#define ROLE_MILITARY_POLICE			16
#define ROLE_CORPORATE_LIAISON			32
#define ROLE_REQUISITION_OFFICER		64
#define ROLE_PILOT_OFFICER				128
#define ROLE_CHIEF_MP					256
#define ROLE_SYNTHETIC					512
#define ROLE_VEHICLE_OFFICER			1024
#define ROLE_ARES						2048
//=================================================
...
#define ROLES_COMMAND 		list("Commander","Executive Officer","Senior Enlisted Advisor","Staff Officer","Pilot Officer","Vehicle Crewman","Military Police","Corporate Liaison","Requisitions Officer","Chief Engineer","Chief Medical Officer","Chief MP")
#define ROLES_OFFICERS		list("Commander","Executive Officer","Senior Enlisted Advisor","Staff Officer","Pilot Officer","Vehicle Crewman","Chief MP","Military Police","Corporate Liaison", "Synthetic", "Ares v3.2")
...
#define ROLES_SQUAD_ALL		list("Alpha") //Bravo,Delta,Charli
...
#define WHITELIST_VEHICLE_CREW		16
#define WHITELIST_COMMANDER			32
#define WHITELIST_SYNTHETIC			64
#define WHITELIST_ARES				128
#define WHITELIST_ADVISOR			256
#define WHITELIST_ARCTURIAN			512
#define WHITELIST_ALL				(WHITELIST_YAUTJA_UNBLOODED|WHITELIST_YAUTJA_BLOODED|WHITELIST_YAUTJA_ELITE|WHITELIST_YAUTJA_ELDER|WHITELIST_VEHICLE_CREW|WHITELIST_COMMANDER|WHITELIST_SYNTHETIC|WHITELIST_ADVISOR|WHITELIST_ARES|WHITELIST_ARCTURIAN)
//=================================================
