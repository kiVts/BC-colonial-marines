...
/datum/shuttle_controller/New()
	...
	for(var/i = 1 to MAIN_SHIP_ESCAPE_POD_NUMBER)
		...
		switch(i) //TODO: Do this procedurally.
			if(10 to 21) P.info_tag = "Alt Almayer Evac"
		P.load_datums()
...
//			dat += "\"[dock_tag]\", "
//		to_chat(world, "<span style='color:#FF0000'>\b warning: shuttles with docking tags [dat] could not find their controllers!</span>")
