...
/datum/marineTech/hivelord
	...
	desc = "Detailed analysis of Hivelord's metabolism shows, that their organism very energy-efficent"
...
/datum/marineTech/burrower
	name = "Burrower metabolism"
	desc = "Detailed analysis of Burrower's metabolism shows, that their organism very energy-efficent"
	resdesc = "Wow. Hivelord cannot be poisoned. It cannot overeat either. Whatever it eats, food will provide 100% nutriment, even if it's drugged. Moreover, Burrower will be basically uncatchable on weed, thanks to sharpened senses and enigmatic connection between xenobiology and xenoflora."
	id = RESEARCH_XENO_HIVELORD
	req_tech = list(RESEARCH_XENO_BIOLOGY, RESEARCH_XENO_MUSCLES, RESEARCH_XENO_CHEMISTRY, RESEARCH_XENO_FLORA, RESEARCH_XENO_DRONE)
