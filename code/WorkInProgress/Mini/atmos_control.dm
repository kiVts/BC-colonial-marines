...
/obj/machinery/computer/atmoscontrol/attackby(var/obj/item/I as obj, var/mob/user as mob)
	if(istype(I, /obj/item/card/emag) && !emagged)
		user.visible_message("<span style='color:#FF0000'>\The [user] swipes \a [I] through \the [src], causing the screen to flash!</span>",\
			"<span style='color:#FF0000'>You swipe your [I] through \the [src], the screen flashing as you gain full control.</span>",\
