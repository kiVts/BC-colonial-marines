...
/obj/effect/proc_holder/spell/targeted/mind_transfer/cast(list/targets,mob/user = usr)
	...
	if(caster.client)
		caster.client.change_view(world.view)
		caster.client.pixel_x = 0
		caster.client.pixel_y = 0
	...
	spawn(msg_wait)
		to_chat(caster, "<span style='color:#FF0000'>You feel woozy and lightheaded. <b>Your body doesn't seem like your own.</b></span>")
