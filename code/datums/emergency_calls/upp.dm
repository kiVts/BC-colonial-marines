...
/datum/emergency_call/upp/print_backstory(mob/living/carbon/human/M)
	...
	to_chat(M, "")
	to_chat(M, "")
	to_chat(M, "<span style='color:#0000FF'>Use say :3 <text> to speak in your native tongue.</span>")
	to_chat(M, "<span style='color:#0000FF'>This allows you to speak privately with your fellow UPP allies.</span>")
	to_chat(M, "<span style='color:#0000FF'>Utilize it with your radio to prevent enemy radio interceptions.</span>")
