...
/obj/item/ammo_magazine/sniper/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/ammo_magazine/rifle/m4ra/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 979225)
	else
		serial_number = given_serial
...
/obj/item/ammo_magazine/rocket/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
