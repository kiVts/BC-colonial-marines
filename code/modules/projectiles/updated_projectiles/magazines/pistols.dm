...
/obj/item/ammo_magazine/smart
	name = "SU-6 Smartpisol Magazines"
	...
	max_rounds = 24
	w_class = 2
	default_ammo = /datum/ammo/bullet/smartpistol
	gun_type = /obj/item/weapon/gun/pistol/smart

/obj/item/ammo_magazine/smart/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/ammo_magazine/pistol/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
