...
//-------------------------------------------------------
//L42 PULSE CARABIN AMMUNITION

/obj/item/ammo_magazine/carabin
	name = "L42 magazine (10x24mm)"
	desc = "A 10mm assault carabin magazine."
	var/serial_number = 0
	caliber = "10x24mm"
	icon_state = "L42"
	w_class = 3
	...
	max_rounds = 20
	gun_type = /obj/item/weapon/gun/rifle/l42

/obj/item/ammo_magazine/carabin/extended
	name = "L42 extended magazine (10x24mm)"
	desc = "A 10mm assault extended carabin magazine."
	max_rounds = 35
	icon_state = "L42_ext"
//	bonus_overlay = "L42_ext"

/obj/item/ammo_magazine/carabin/ap
	name = "L42 AP magazine (10x24mm)"
	desc = "A 10mm assault carabin magazine."
	icon_state = "L42_ap"
	default_ammo = /datum/ammo/bullet/rifle/ap

/obj/item/ammo_magazine/carabin/incendiary
	name = "L42 incendiary magazine (10x24mm)"
	desc = "A 10mm assault carabin magazine."
	icon_state = "L42_incendiary"
	default_ammo = /datum/ammo/bullet/rifle/incendiary

/obj/item/ammo_magazine/carabin/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/ammo_magazine/rifle/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 979225)
	else
		serial_number = given_serial
...
/obj/item/ammo_magazine/rifle/m46c
	name = "M46C ammo box (20x48mm)"
	desc = "A semi-rectangular box of rounds for the M41AE2 Heavy Pulse Rifle."
	icon_state = "m41ae2"
	max_rounds = 300
