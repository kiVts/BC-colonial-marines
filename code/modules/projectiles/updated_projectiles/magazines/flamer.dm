...
/obj/item/ammo_magazine/flamer_tank/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 479225)
	else
...
/obj/item/ammo_magazine/flamer_tank/largeg	// Extra thicc tank
	name = "large incinerator tank (GEL)"
	desc = "A large fuel tank of Ultra Thick Gel Fuel,a sticky combustable liquid chemical, for use in the M240A1 incinerator unit. Handle with care."
