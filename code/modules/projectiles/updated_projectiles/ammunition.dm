...
/obj/item/ammobox/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/ammo_magazine/shotgunbox/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 979225)
	else
		serial_number = given_serial
...
/obj/item/ammobox/inc
	name = "M41A Incendiary Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	...
	max_magazine_amount = 10
	max_magazine_rounds = 40
	ammo_type = /datum/ammo/bullet/rifle/incendiary
	magazine_type = /obj/item/ammo_magazine/rifle/incendiary
	base = /obj/item/ammobox/inc
...
/obj/item/ammobox/m39inc
	name = "M39 Incendiary Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammoboxm39inc"
	item_state = "ammoboxm39inc"
	base_icon_state = "ammoboxm39inc"
	max_magazine_amount = 10
	max_magazine_rounds = 48
	ammo_type = /datum/ammo/bullet/smg
	magazine_type = /obj/item/ammo_magazine/smg/m39/incendiary
	base = /obj/item/ammobox/m39inc
...
/obj/item/ammobox/m39le
	name = "M39 Light Explosive Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammoboxm39le"
	item_state = "ammoboxm39le"
	base_icon_state = "ammoboxm39le"
	max_magazine_amount = 10
	max_magazine_rounds = 6
	ammo_type = /datum/ammo/bullet/smg/le
	magazine_type = /obj/item/ammo_magazine/smg/m39/le
	base = /obj/item/ammobox/m39le
...
/obj/item/ammobox/l42ext
	name = "L42 Extended Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammoboxL42ext"
	item_state = "ammoboxL42ext"
	base_icon_state = "ammoboxL42ext"
	max_magazine_amount = 10
	max_magazine_rounds = 35
	ammo_type = /datum/ammo/bullet/rifle
	magazine_type = /obj/item/ammo_magazine/carabin/extended
	base = /obj/item/ammobox/l42ext

/obj/item/ammobox/l42
	name = "L42 Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammoboxL42"
	item_state = "ammoboxL42"
	base_icon_state = "ammoboxL42"
	max_magazine_amount = 10
	max_magazine_rounds = 20
	ammo_type = /datum/ammo/bullet/rifle
	magazine_type = /obj/item/ammo_magazine/carabin
	base = /obj/item/ammobox/l42

/obj/item/ammobox/l42incendiary
	name = "L42 Incendiary Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammoboxL42incendiary"
	item_state = "ammoboxL42incendiary"
	base_icon_state = "ammoboxL42incendiary"
	max_magazine_amount = 10
	max_magazine_rounds = 20
	ammo_type = /datum/ammo/bullet/rifle/incendiary
	magazine_type = /obj/item/ammo_magazine/carabin/incendiary
	base = /obj/item/ammobox/l42incendiary

/obj/item/ammobox/l42ap
	name = "L42 AP Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammoboxL42ap"
	item_state = "ammoboxL42ap"
	base_icon_state = "ammoboxL42ap"
	max_magazine_amount = 10
	max_magazine_rounds = 20
	ammo_type = /datum/ammo/bullet/rifle/ap
	magazine_type = /obj/item/ammo_magazine/carabin/ap
	base = /obj/item/ammobox/l42ap


/obj/item/ammobox/smart
	name = "Smart Pistol Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammoboxsu6"
	item_state = "ammoboxsu6"
	base_icon_state = "ammoboxsu6"
	max_magazine_amount = 10
	max_magazine_rounds = 24
	ammo_type = /datum/ammo/bullet/smartpistol
	magazine_type = /obj/item/ammo_magazine/smart
	base = /obj/item/ammobox/smart

/obj/item/ammobox/vp78
	name = "VP 78 Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammoboxvp78"
	item_state = "ammoboxvp78"
	base_icon_state = "ammoboxvp78"
	max_magazine_amount = 10
	max_magazine_rounds = 18
	ammo_type = /datum/ammo/bullet/pistol/squash
	magazine_type = /obj/item/ammo_magazine/pistol/vp78
	base = /obj/item/ammobox/vp78

/obj/item/ammobox/s88mod4
	name = "88 mod 4 Ammo Box"
	icon = 'icons/obj/items/ammo.dmi'
	icon_state = "ammobox88mod4ap"
	item_state = "ammobox88mod4ap"
	base_icon_state = "ammobox88mod4ap"
	max_magazine_amount = 10
	max_magazine_rounds = 50
	ammo_type = /datum/ammo/bullet/pistol/squash
	magazine_type = /obj/item/ammo_magazine/pistol/auto9
	base = /obj/item/ammobox/s88mod4
