...
//-------------------------------------------------------
//M46C HEAVY PULSE RIFLE

/obj/item/weapon/gun/rifle/m46c
	name = "M46C pulse rifle"
	desc = "The Vip issue experemental pulse rifle of the Command. Uses 20x48mm caseless ammunition."
	var/serial_number = 0
	icon_state = "m46c"
	item_state = "m46c"
	fire_sound = "sound/weapons/gun_m46c.ogg"
	current_mag = /obj/item/ammo_magazine/rifle/m46c
	attachable_allowed = list(
						...
						/obj/item/attachable/fverticalgrip,
						/obj/item/attachable/scope/iftsscope,
...
/obj/item/weapon/gun/rifle/lmg/set_gun_config_values()
	...
	damage_mult = config.base_hit_damage_mult * 2
	recoil_unwielded = config.max_recoil_value

/obj/item/weapon/gun/rifle/m46c/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 5)
	else
...
/obj/item/weapon/gun/rifle/m41a/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/weapon/gun/rifle/l42
	name = "L42 pulse carabin"
	desc = "The Vip issue carabin of the Colonial Marines. Commonly carried by most combat personnel. Uses 10x24mm caseless ammunition."
	var/serial_number = 0
	icon_state = "l42"
	item_state = "l42"
	fire_sound = "sound/weapons/gun_carabin.ogg"
	current_mag = /obj/item/ammo_magazine/carabin
	attachable_allowed = list(
						/obj/item/attachable/suppressor,
						/obj/item/attachable/bayonet,
						/obj/item/attachable/reddot,
						...
						/obj/item/attachable/flashlight,
						/obj/item/attachable/bipod,
						/obj/item/attachable/stock/l_stock,
						/obj/item/attachable/compensator,
						/obj/item/attachable/quickfire,
						/obj/item/attachable/extended_barrel,
						/obj/item/attachable/heavy_barrel,
...
/obj/item/weapon/gun/rifle/l42/New()
	..()
	attachable_offset = list("muzzle_x" = 32, "muzzle_y" = 18,"rail_x" = 19, "rail_y" = 18, "under_x" = 22, "under_y" = 16, "stock_x" = 20, "stock_y" = 16)
...
/obj/item/weapon/gun/rifle/l42/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 59225)
	else
		serial_number = given_serial
	desc += " Серийный номер [serial_number]"
	..(loc)
...
/obj/item/weapon/gun/rifle/m41a/elite/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 29225)
	else
		serial_number = given_serial
	desc += " Серийный номер [serial_number]"
	..(loc)
...
/obj/item/weapon/gun/rifle/m41aMK1/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 12357)
	else
		serial_number = given_serial
	desc += " Серийный номер [serial_number]"
	..(loc)
...
/obj/item/weapon/gun/rifle/mar40/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/rifle/mar40/carbine/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/rifle/m16/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/rifle/lmg/set_gun_config_values()
	...
	burst_amount = config.high_burst_value
	burst_delay = config.min_fire_delay * 2
	accuracy_mult = config.base_hit_accuracy_mult
	accuracy_mult_unwielded = config.base_hit_accuracy_mult - config.max_hit_accuracy_mult
	scatter = config.low_scatter_value
	scatter_unwielded = config.max_scatter_value * 2
...
/obj/item/weapon/gun/rifle/lmg/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/rifle/type71/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/rifle/type71/carbine/commando/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 7225)
	else
		serial_number = given_serial
	desc += " Серийный номер [serial_number]"
	..(loc)
