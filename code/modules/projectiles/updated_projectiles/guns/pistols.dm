...
/obj/item/weapon/gun/pistol
	...
	flags_gun_features = GUN_AUTO_EJECTOR|GUN_CAN_POINTBLANK|GUN_TRIGGER_SAFETY //For easy reference.
...
/obj/item/weapon/gun/pistol/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 871225)
	else
...
/obj/item/weapon/gun/pistol/smart
	...
	desc = "The SU-6 Smartpistol is an IFF-based sidearm currently undergoing field testing in the Colonial Marines. Uses modified .45 ACP IFF bullets. Capable of firing in bursts. Found in the Experimental Trooper Kits located in squad requisitions or requisitions itself."
	icon_state = "smart"
	item_state = "smart"
	fire_sound = 'sound/weapons/gun_glock.ogg'
	current_mag = /obj/item/ammo_magazine/smart
...
/obj/item/weapon/gun/pistol/smart/examine(mob/user)
	..()
...
/obj/item/weapon/gun/pistol/smart/unique_action(mob/user)
	toggle_restriction(user)

/obj/item/weapon/gun/pistol/smart/proc/toggle_restriction(mob/user)
...
/obj/item/weapon/gun/pistol/smart/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 21225)
	else
		serial_number = given_serial
	desc += " Серийный номер [serial_number]"
	..(loc)
...
/obj/item/weapon/gun/pistol/m4a3/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/weapon/gun/pistol/m4a3/custom/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 39225)
	else
		serial_number = given_serial
	desc += " Серийный номер [serial_number]"
	..(loc)
...
/obj/item/weapon/gun/pistol/m1911/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/pistol/b92fs/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/pistol/heavy/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/pistol/c99/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/weapon/gun/pistol/kt42/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/pistol/highpower/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/pistol/vp70/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/pistol/vp78/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/pistol/auto9/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/pistol/chimp
	...
	gun_skill_category = GUN_SKILL_PISTOLS
	attachable_allowed = list()
	flags_gun_features = GUN_AUTO_EJECTOR|GUN_WY_RESTRICTED|GUN_TRIGGER_SAFETY
...
/obj/item/weapon/gun/pistol/holdout/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
