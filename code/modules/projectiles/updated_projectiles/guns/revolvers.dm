...
/obj/item/weapon/gun/revolver/proc/revolver_basic_spin(mob/living/carbon/human/user, direction = 1, obj/item/weapon/gun/revolver/double)
	...
	if(double)
		user.visible_message("[user] deftly flicks and spins [src] and [double]!","<span style='color:#0000FF'>You flick and spin [src] and [double]!</span>")
		animation_wrist_flick(double, 1)
	else user.visible_message("[user] deftly flicks and spins [src]!","<span style='color:#0000FF'>You flick and spin [src]!</span>")
...
/obj/item/weapon/gun/revolver/proc/revolver_throw_catch(mob/living/carbon/human/user)
	set waitfor = 0
	user.visible_message("[user] deftly flicks [src] and tosses it into the air!","<span style='color:#0000FF'>You flick and toss [src] into the air!</span>")
	...
	if(loc && user)
		...
		if(user.get_inactive_hand())
			user.visible_message("[user] catches [src] with the same hand!","<span style='color:#0000FF'>You catch [src] as it spins in to your hand!</span>")
		else
			user.visible_message("[user] catches [src] with his other hand!","<span style='color:#0000FF'>You snatch [src] with your other hand! Awesome!</span>")
...
/obj/item/weapon/gun/revolver/upp/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/weapon/gun/revolver/small/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
...
/obj/item/weapon/gun/revolver/mateba/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/weapon/gun/revolver/cmb/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 79225)
	else
		serial_number = given_serial
