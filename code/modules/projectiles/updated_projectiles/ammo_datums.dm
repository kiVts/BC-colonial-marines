...
/datum/ammo/bullet/smg/le
	name = "light explosive submachinegun bullet"
	ping = null //no bounce off.
	sound_bounce	= "bounce"
	damage_falloff = 0
...
/datum/ammo/bullet/smg/le/on_hit_mob(mob/M, obj/item/projectile/P)
	explosion(get_turf(M), -1, -1, 1, 1)

/datum/ammo/bullet/smg/le/on_hit_obj(obj/O, obj/item/projectile/P)
	explosion(get_turf(O), -1, -1, 1, 1)

/datum/ammo/bullet/smg/le/on_hit_turf(turf/T, obj/item/projectile/P)
	explosion(T,  -1, -1, 1, 1)

/datum/ammo/bullet/smg/le/do_at_max_range(obj/item/projectile/P)
	explosion(get_turf(P),  -1, -1, 1, 1)
...
/datum/ammo/bullet/sniper/flak/on_hit_mob(mob/M,obj/item/projectile/P)
	area_stagger_burst(get_turf(M), P, 0, 0, 2, 4, 0, 1, 3, 2)
...
// - Coder anyone: no IFF for communistic pigs!
// - BlackCrystalic: fuck you , niger
