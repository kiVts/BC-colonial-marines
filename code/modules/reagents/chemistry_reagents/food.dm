	...
	on_mob_life(mob/living/M)
		...
		if(ishuman(M))
			...
			if(H.species && !(H.species.flags & (NO_PAIN|IS_SYNTHETIC)) )
				switch(data)
					if(1 to 2)
						to_chat(H, "<span style='color:#FF0000'><b>Your insides feel uncomfortably hot !</b></span>")
					if(2 to 20)
						if(prob(5))
							to_chat(H, "<span style='color:#FF0000'><b>Your insides feel uncomfortably hot !</b></span>")
					if(20 to INFINITY)
						...
						if(prob(5))
							...
							to_chat(H, "<span style='color:#FF0000'><b>You feel like your insides are burning !</b></span>")
		...
		if(method == TOUCH)
			if(istype(M, /mob/living/carbon/human))
				...
				if( eyes_covered && mouth_covered )
					to_chat(victim, "<span style='color:#FF0000'>Your [safe_thing.name] protects you from the pepperspray!</span>")
					return
				else if( eyes_covered )	// Reduced effects if partially protected
					to_chat(victim, "<span style='color:#FF0000'>Your [safe_thing] protect you from most of the pepperspray!</span>")
					...
					to_chat(victim, "<span style='color:#FF0000'>Your [safe_thing] protects your face from the pepperspray!</span>")
					...
					if(!(victim.species && (victim.species.flags & NO_PAIN)))
						victim.emote("scream")
					to_chat(victim, "<span style='color:#FF0000'>You're sprayed directly in the eyes with pepperspray!</span>")
