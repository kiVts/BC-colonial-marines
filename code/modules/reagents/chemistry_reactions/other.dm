...
/datum/chemical_reaction/foam
	...
	on_reaction(var/datum/reagents/holder, var/created_volume)
		...
		for(var/mob/M in viewers(5, location))
			to_chat(M, "<span style='color:#FF0000'>The solution violently bubbles!</span>")

		location = get_turf(holder.my_atom)

		for(var/mob/M in viewers(5, location))
			to_chat(M, "<span style='color:#FF0000'>The solution spews out foam!</span>")
...
/datum/chemical_reaction/metalfoam
	...
	on_reaction(var/datum/reagents/holder, var/created_volume)
		...
		for(var/mob/M in viewers(5, location))
			to_chat(M, "<span style='color:#FF0000'>The solution spews out a metalic foam!</span>")
