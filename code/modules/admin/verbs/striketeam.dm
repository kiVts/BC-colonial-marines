...
//Spawns commandos and equips them.
	for(var/obj/effect/landmark/L in landmarks_list)
		...
		if (L.name == "Commando")
			...
			to_chat(new_commando, "<span style='color:#0000FF'>You are a Special Ops. [!leader_selected?"commando":"<B>LEADER</B>"] in the service of Central Command. Check the table ahead for detailed instructions.\nYour current mission is: \red<B>[input]</B></span>")
...
//Spawns the rest of the commando gear.
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] has spawned a CentCom strike squad.</span>", 1)
