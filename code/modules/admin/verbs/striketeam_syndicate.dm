...
//Spawns commandos and equips them.
	for(var/obj/effect/landmark/L in landmarks_list)
		...
		if (L.name == "Syndicate-Commando")
			...
			to_chat(new_syndicate_commando, "<span style='color:#0000FF'>You are an Elite Syndicate. [!syndicate_leader_selected?"commando":"<B>LEADER</B>"] in the service of the Syndicate. \nYour current mission is: \red<B>[input]</B></span>")
...
//	for (var/obj/effect/landmark/L)
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] has spawned a Syndicate strike squad.</span>", 1)
...
/mob/living/carbon/human/proc/equip_syndicate_commando(syndicate_leader_selected = 0)
	...
	W.access += list(ACCESS_WY_CORPORATE, ACCESS_ILLEGAL_PIRATE)
