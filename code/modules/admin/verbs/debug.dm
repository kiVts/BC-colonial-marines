...
/client/proc/callatomproc(atom/A)
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(src)] called [A]'s [procname]() with [lst.len ? "the arguments [list2params(lst)]":"no arguments"].</span>")
...
/client/proc/Cell()
	...
	var/t = "<span style='color:#0000FF'>Coordinates: [T.x],[T.y],[T.z]\n</span>"
	t += "<span style='color:#FF0000'>Temperature: [air_info[2]]\n</span>"
	t += "<span style='color:#FF0000'>Pressure: [air_info[3]]kPa\n</span>"
	t += "<span style='color:#0000FF'>Gas Type: [air_info[1]]\n</span>"
...
/client/proc/cmd_admin_alienize(var/mob/M in mob_list)
	...
	if(ishuman(M))
		...
		message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] made [key_name(M)] into an alien.</span>", 1)
	else
		alert("Invalid mob")
...
/client/proc/cmd_admin_change_hivenumber(mob/living/carbon/Xenomorph/M in mob_list, var/hivenumber = XENO_HIVE_NORMAL)
	...
	if(isXeno(M))
		...
		message_admins("<span style='color:#0000FF'>[key_name(src)] changed hivenumber of [M] to [M.hivenumber].</span>", 1)
	else
		alert("Invalid mob")
...
/client/proc/cmd_admin_grantfullaccess(var/mob/M in mob_list)
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] has granted [M.key] full access.</span>", 1)
...
/client/proc/cmd_admin_grantallskills(var/mob/M in mob_list)
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] has granted [M.key] all skills.</span>", 1)
...
/client/proc/cmd_assume_direct_control(var/mob/M in mob_list)
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] assumed direct control of [M].</span>", 1)
...
/client/proc/setup_supermatter_engine()
	...
	if(!found_the_pump && response == "Setup Completely")
		to_chat(src, "<span style='color:#FF0000'>Unable to locate air supply to fill up with coolant, adding some coolant around the supermatter</span>")



	log_admin("[key_name(usr)] setup the supermatter engine [response == "Setup except coolant" ? "without coolant" : ""]")
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] setup the supermatter engine  [response == "Setup except coolant" ? "without coolant": ""]</span>", 1)
	return
