...
/proc/notes_add(var/key, var/note, var/mob/usr)
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] has edited [key]'s notes: [sanitize(note)]</span>")
...
/proc/notes_del(var/key, var/index)
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] deleted one of [key]'s notes.</span>")
