...
/datum/admins/proc/restart()
	...
	if(confirm == "Cancel")
		return
	if(confirm == "Yes")
		to_chat(world, "<span style='color:#FF0000'><b>Restarting world!</b> \blue Initiated by [usr.client.holder.fakekey ? "Admin" : usr.key]!</span>")
...
/datum/admins/proc/announce()
	...
	if(message)
		...
		to_chat(world, "<span style='color:#0000FF'><b>[usr.client.holder.fakekey ? "Administrator" : usr.key] Announces:</b>\n \t [message]</span>")
...
/datum/admins/proc/togglejoin()
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] toggled new player game joining.</span>", 1)
	world.update_status()
...
/datum/admins/proc/toggleaban()
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] toggled respawn to [abandon_allowed ? "On" : "Off"].</span>", 1)
...
/datum/admins/proc/end_round()
	...
	if (ticker)
		...
		message_admins("<span style='color:#0000FF'>[key_name(usr)] has made the round end early.</span>", 1)
		for(var/client/C in admins)
			to_chat(C, "<hr>")
...
/datum/admins/proc/adjump()
	...
	message_admins("<span style='color:#0000FF'>Toggled admin jumping to [config.allow_admin_jump].</span>")
...
/datum/admins/proc/adspawn()
	...
	message_admins("<span style='color:#0000FF'>Toggled admin item spawning to [config.allow_admin_spawning].</span>")
...
/datum/admins/proc/adrev()
	...
	message_admins("<span style='color:#0000FF'>Toggled reviving to [config.allow_admin_rev].</span>")
...
/datum/admins/proc/immreboot()
	...
	if( alert("Reboot server?",,"Yes","No") == "No")
		return
	to_chat(world, "<span style='color:#FF0000'><b>Rebooting world!</b> \blue Initiated by [usr.client.holder.fakekey ? "Admin" : usr.key]!</span>")
...
/datum/admins/proc/toggleguests()
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] toggled guests game entering [guests_allowed?"":"dis"]allowed.</span>", 1)
...
/datum/admins/proc/admin_force_distress()
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] admin-called a [choice == "Randomize" ? "randomized ":""]distress beacon: [ticker.mode.picked_call.name]</span>", 1)
...
/datum/admins/proc/admin_force_ERT_shuttle()
	...
	message_admins("<span style='color:#0000FF'>[key_name_admin(usr)] force launched a distress shuttle ([tag])</span>", 1)
