...
/obj/item/grown/nettle/pickup(mob/living/carbon/human/user as mob)
	if(istype(user) && !user.gloves)
		to_chat(user, "<span style='color:#FF0000'>The nettle burns your bare hand!</span>")
...
/obj/item/grown/nettle/death/pickup(mob/living/carbon/human/user as mob)
	...
	if(..() && prob(50))
		user.KnockOut(5)
		to_chat(user, "<span style='color:#FF0000'>You are stunned by the deathnettle when you try picking it up!</span>")
...
/obj/item/grown/nettle/death/attack(mob/living/carbon/M as mob, mob/user as mob)
	...
	if(istype(M, /mob/living))
		to_chat(M, "<span style='color:#FF0000'>You are stunned by the powerful acid of the deathnettle!</span>")
