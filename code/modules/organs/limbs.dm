...
/datum/limb
	...
	var/damage_msg = "<span style='color:#FF0000'>You feel an intense pain</span>"
...
/datum/limb/head/proc/disfigure(var/type = "brute")
	if (disfigured)
		return
	if(type == "brute")
		owner.visible_message("<span style='color:#FF0000'>You hear a sickening cracking sound coming from \the [owner]'s face.</span>",	\
		"<span style='color:#FF0000'><b>Your face becomes unrecognizible mangled mess!</b></span>",	\
		"<span style='color:#FF0000'>You hear a sickening crack.</span>")
	else
		owner.visible_message("<span style='color:#FF0000'>[owner]'s face melts away, turning into mangled mess!</span>",	\
		"<span style='color:#FF0000'><b>Your face melts off!</b></span>",	\
		"<span style='color:#FF0000'>You hear a sickening sizzle.</span>")
	disfigured = 1
