...
/mob/verb/abandon_mob()
	...
	if (!( abandon_allowed ) && !is_admin)
		to_chat(usr, "<span style='color:#0000FF'>Respawn is disabled.</span>")
		return
	if ((stat != 2 || !( ticker )))
		to_chat(usr, "<span style='color:#0000FF'><B>You must be dead to use this!</B></span>")
		return
	if (ticker.mode.name == "meteor" || ticker.mode.name == "epidemic") //BS12 EDIT
		to_chat(usr, "<span style='color:#0000FF'>Respawn is disabled for this roundtype.</span>")
		return
	else
...
//				to_chat(usr, "<span style='color:#0000FF'><B>Upon using the antagHUD you forfeighted the ability to join the round.</B></span>")
//				return
	...
	to_chat(usr, "<span style='color:#0000FF'><B>Make sure to play a different character, and please roleplay correctly!</B></span>")
...
/mob/verb/observe()
	...
	if(client.holder && (client.holder.rights & R_ADMIN))
		...
		to_chat(usr, "<span style='color:#0000FF'>You must be observing to use this!</span>")
		return
