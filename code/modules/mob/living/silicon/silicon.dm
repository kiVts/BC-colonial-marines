...
/mob/living/silicon/emp_act(severity)
	...
	to_chat(src, "<span style='color:#FF0000'><B>*BZZZT*</B></span>")
	to_chat(src, "<span style='color:#FF0000'>Warning: Electromagnetic pulse detected.</span>")
	..()
...
/mob/living/silicon/electrocute_act(var/shock_damage, var/obj/source, var/siemens_coeff = 1.0)
	...
	if (istype(source, /obj/machinery/containment_field))
		...
		visible_message("<span style='color:#FF0000'>[src] was shocked by \the [source]!</span>", \
			"<span style='color:#FF0000'><B>Energy pulse detected, system damaged!</B></span>", \
			"<span style='color:#FF0000'>You hear an electrical crack</span>")
		if(prob(20))
			Stun(2)
		return
...
/mob/living/silicon/proc/toggle_sensor_mode()
	...
	if(HUD_toggled[HUD_nbr])
		...
		to_chat(src, "<span style='color:#0000FF'><B>[hud_choice] Disabled</B></span>")
	else
		HUD_toggled[HUD_nbr] = 1
		H.add_hud_to(src)
		to_chat(src, "<span style='color:#0000FF'><B>[hud_choice] Enabled</B></span>")
