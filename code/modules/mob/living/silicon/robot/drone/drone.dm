...
/mob/living/silicon/robot/drone/attackby(obj/item/W, mob/living/user)
	...
	if(istype(W, /obj/item/robot/upgrade/))
		to_chat(user, "<span style='color:#FF0000'>The maintenance drone chassis not compatible with \the [W].</span>")
		return
...
/mob/living/silicon/robot/drone/proc/law_resync()
	if(stat != 2)
		to_chat(src, "<span style='color:#FF0000'>A reset-to-factory directive packet filters through your data connection, and you obediently modify your programming to suit it.</span>")
		full_law_reset()
		show_laws()

/mob/living/silicon/robot/drone/proc/shut_down()
	if(stat != 2)
		to_chat(src, "<span style='color:#FF0000'>You feel a system kill order percolate through your tiny brain, and you obediently destroy yourself.</span>")
		death()
