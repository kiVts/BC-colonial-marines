/mob/living/carbon/human/verb/quick_equip()
	...
	if(ishuman(src))
		...
		if(H.equip_to_appropriate_slot(I, 0))
			...
			to_chat(H, "<span style='color:#FF0000'>You are unable to equip that.</span>")
...
/mob/living/carbon/human/equip_to_slot(obj/item/W as obj, slot)
	...
	switch(slot)
		...
		if(WEAR_IN_J_HOLSTER)
			...
			to_chat(src, "<span style='color:#FF0000'>You are trying to eqip this item to an unsupported inventory slot. How the heck did you manage that? Stop it...</span>")
			return
