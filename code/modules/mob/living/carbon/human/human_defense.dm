...
/mob/living/carbon/human/proc/attacked_by(var/obj/item/I, var/mob/living/user, var/def_zone)
	...
	if(!target_zone)
		visible_message("<span style='color:#FF0000'><B>[user] misses [src] with \the [I]!</span>", null, null, 5)
		return 0
	...
	if(I.attack_verb && I.attack_verb.len)
		visible_message("<span style='color:#FF0000'><B>[src] has been [pick(I.attack_verb)] in the [hit_area] with [I.name] by [user]!</B></span>", null, null, 5)
	else
		visible_message("<span style='color:#FF0000'><B>[src] has been attacked in the [hit_area] with [I.name] by [user]!</B></span>", null, null, 5)
		...
		switch(hit_area)
			...
			if("chest")//Easier to score a stun but lasts less time
				if(prob((I.force + 10)))
					...
					visible_message("<span style='color:#FF0000'><B>[src] has been knocked down!</B></span>", null, null, 5)
...
/mob/living/carbon/human/hitby(atom/movable/AM,var/speed = 5)
	if(istype(AM,/obj/))
		...
		if(!zone)
			visible_message("<span style='color:#0000FF'>\The [O] misses [src] narrowly!</span>", null, null, 5)
			return
		...
		src.visible_message("<span style='color:#FF0000'>[src] has been hit in the [hit_area] by [O].</span>", null, null, 5)
		...
		if(O.throw_source && speed >= 15)
			...
			visible_message("<span style='color:#FF0000'>[src] staggers under the impact!","\red You stagger under the impact!</span>", null, null, 5)
