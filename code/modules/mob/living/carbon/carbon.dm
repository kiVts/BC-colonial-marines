	...
	if(user in src.stomach_contents)
		...
		if(prob(30))
			for(var/mob/M in hearers(4, src))
				if(M.client)
					M.show_message("<span style='color:#FF0000'>You hear something rumbling inside [src]'s stomach...</span>", 2)
		...
		if(I && I.force)
			...
			for(var/mob/M in viewers(user, null))
				if(M.client)
					M.show_message(text("<span style='color:#FF0000'><B>[user] attacks [src]'s stomach wall with the [I.name]!</span>"), 2)
...
/mob/living/carbon/electrocute_act(var/shock_damage, var/obj/source, var/siemens_coeff = 1.0, var/def_zone = null)
	...
	if (shock_damage > 10)
		src.visible_message(
			"<span style='color:#FF0000'>[src] was shocked by the [source]!</span>", \
			"<span style='color:#FF0000'><B>You feel a powerful shock course through your body!</B></span>", \
			"<span style='color:#FF0000'>You hear a heavy electrical crack.</span>" \
		)
		...
		src.visible_message(
			"<span style='color:#FF0000'>[src] was mildly shocked by the [source].</span>", \
			"<span style='color:#FF0000'>You feel a mild shock course through your body.</span>", \
			"<span style='color:#FF0000'>You hear a light zapping.</span>" \
		)
...
/mob/living/carbon/verb/mob_sleep()
	...
	if(usr.sleeping)
		to_chat(usr, "<span style='color:#FF0000'>You are already sleeping</span>")
		return
