...
/mob/living/proc/run_armor_check(var/def_zone = null, var/attack_flag = "melee", var/absorb_text = null, var/soften_text = null)
	...
	if(absorb >= 2)
		if(absorb_text)
			...
			show_message("<span style='color:#FF0000'>Your armor absorbs the blow!</span>")
		return 2
	if(absorb == 1)
		if(absorb_text)
			show_message("[soften_text]")
		else
			show_message("<span style='color:#FF0000'>Your armor softens the blow!</span>")
		return 1
	return 0
...
/mob/living/hitby(atom/movable/AM as mob|obj,var/speed = 5)//Standardization and logging -Sieve
	if(istype(AM,/obj/))
		...
		src.visible_message("<span style='color:#FF0000'>[src] has been hit by [O].</span>", null, null, 5)
		...
		if(O.throw_source && speed >= 15)
			...
			visible_message("<span style='color:#FF0000'>[src] staggers under the impact!","\red You stagger under the impact!</span>", null, 5)
