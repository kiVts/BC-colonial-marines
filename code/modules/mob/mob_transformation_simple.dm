...
/mob/proc/change_mob_type(var/new_type = null, var/turf/location = null, var/new_name = null as text, var/delete_old_mob = 0 as num, var/subspecies)
	...
	if(istype(src,/mob/new_player))
		to_chat(usr, "<span style='color:#FF0000'>cannot convert players who have not entered yet.</span>")
		return
	...
	if( new_type == /mob/new_player )
		to_chat(usr, "<span style='color:#FF0000'>cannot convert into a new_player mob type.</span>")
		return
