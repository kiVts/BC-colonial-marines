...
/mob/proc/print_flavor_text()
	if (flavor_text && flavor_text != "")
		...
		if(length(msg) <= 40)
			...
			return "<span style='color:#0000FF'>[copytext(msg, 1, 37)]... <a href='byond://?src=\ref[src];flavor_more=1'>More...</a></span>"
...
/mob/living/start_pulling(atom/movable/AM, lunge, no_msg)
	...
	if(M)
		...
		msg_admin_attack("[key_name(src)] схватил [key_name(M)]" )

		if(!no_msg)
			visible_message("<span class='warning'>[src] схватил [M] passively!</span>", null, null, 5)
