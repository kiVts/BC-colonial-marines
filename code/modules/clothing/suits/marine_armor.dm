...
/obj/item/clothing/suit/storage/marine/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
...
/obj/item/clothing/suit/storage/marine/l
	name = "M3 light armor"
	desc = "A standard light Colonial Marines M3 light Pattern Chestplate. Protects the chest from ballistic rounds, bladed objects and accidents. It has a small leather pouch strapped to it for limited storage."
	icon = 'icons/obj/clothing/cm_suits.dmi'
	icon_state = "1l"
	item_state = "armorl"
	sprite_sheet_id = 1
	...
	max_heat_protection_temperature = ARMOR_max_heat_protection_temperature
	blood_overlay_type = "armor"
	armor = list(melee = 40, bullet = 30, laser = 25, energy = 15, bomb = 20, bio = 0, rad = 0)
	siemens_coefficient = 0.7
	...
	New(loc,expected_type 	= type,
		new_name[] 		= list(MAP_ICE_COLONY = "M3 light pattern snow armor"))
		..(loc,expected_type,new_name)




/obj/item/clothing/suit/storage/marine/h
	name = "M3 heavy armor"
	desc = "A standard heavy Colonial Marines M3 heavy Pattern Chestplate. Protects the chest from ballistic rounds, bladed objects and accidents. It has a small leather pouch strapped to it for limited storage."
	icon = 'icons/obj/clothing/cm_suits.dmi'
	icon_state = "1h"
	item_state = "armorh"
	sprite_sheet_id = 1
	...
	max_heat_protection_temperature = ARMOR_max_heat_protection_temperature
	blood_overlay_type = "armor"
	armor = list(melee = 75, bullet = 70, laser = 60, energy = 50, bomb = 55, bio = 10, rad = 10)
	siemens_coefficient = 0.7
	slowdown = SLOWDOWN_ARMOR_VERY_HEAVY

	New(loc,expected_type 	= type,
		new_name[] 		= list(MAP_ICE_COLONY = "M3 heavy pattern snow armor"))
		..(loc,expected_type,new_name)




/obj/item/clothing/suit/storage/marine/c
	name = "Command armor"
	desc = "A very rare Command Armor only for high command. Protects the chest from ballistic rounds, bladed objects and accidents. It has a small leather pouch strapped to it for limited storage."
	icon = 'icons/obj/clothing/cm_suits.dmi'
	icon_state = "1h"
	item_state = "armorh"
	sprite_sheet_id = 1
	...
	max_heat_protection_temperature = ARMOR_max_heat_protection_temperature
	blood_overlay_type = "armor"
	armor = list(melee = 100, bullet = 150, laser = 150, energy = 150, bomb = 150, bio = 150, rad = 150)
	siemens_coefficient = 0.7
	slowdown = SLOWDOWN_ARMOR_VERY_LIGHT
...
/obj/item/clothing/suit/storage/marine/leader
	...
	New(loc,expected_type 	= type,
		new_name[] 		= list(MAP_ICE_COLONY = "B12 pattern leader snow armor"))
		..(loc,expected_type,new_name)

/obj/item/clothing/suit/storage/marine/tanker
	name = "M3 pattern tanker armor"
...
/obj/item/clothing/suit/storage/marine/specialist
	...
	icon_state = "xarmor"
	armor = list(melee = 95, bullet = 110, laser = 80, energy = 80, bomb = 120, bio = 20, rad = 20)
	...
	New(loc,expected_type 	= type,
		new_name[] 		= list(MAP_ICE_COLONY = "B18 defensive snow armor"))
		..(loc,expected_type,new_name)
...
/obj/item/clothing/suit/storage/marine/sniper
	...
	New(loc,expected_type 	= type,
		new_name[] 		= list(MAP_ICE_COLONY = "M3 pattern sniper snow armor"))
		..(loc,expected_type,,new_name)
...
/obj/item/clothing/suit/storage/marine/sniper/jungle
	...
	New(loc,expected_type 	= type,
		new_name[] 		= list(MAP_ICE_COLONY = "M3 pattern marksman snow armor"))
		..(loc,expected_type,,new_name)
