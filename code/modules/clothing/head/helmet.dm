...
/obj/item/clothing/head/helmet/marine/c
	name = "Command helmet"
	desc = "A very rare Command Helmet only for high command. It reads on the label, 'The difference between an open-casket and closed-casket funeral. Wear on head for best results.'. Contains a small built-in camera."
	armor = list(melee = 125, bullet = 175, laser = 175, energy = 175, bomb = 175, bio = 175, rad = 175)
...
/obj/item/clothing/head/helmet/marine/specialist
	...
	armor = list(melee = 95, bullet = 105, laser = 75, energy = 65, bomb = 120, bio = 15, rad = 15)
	unacidable = 1
	anti_hug = 6
