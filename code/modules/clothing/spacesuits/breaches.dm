...
/obj/item/clothing/suit/space/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/stack/sheet/mineral/plastic) || istype(W,/obj/item/stack/sheet/metal))
		...
		if(istype(src.loc,/mob/living))
			to_chat(user, "<span style='color:#FF0000'>How do you intend to patch a hardsuit while someone is wearing it?</span>")
			return
		...
		if(!WT.remove_fuel(5))
			to_chat(user, "<span style='color:#FF0000'>You need more welding fuel to repair this suit.</span>")
			return
