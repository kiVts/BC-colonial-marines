...
/client/proc/Set_Holiday(T as text|null)
	...
	message_admins("<span style='color:#0000FF'>ADMIN: Event: [key_name(src)] force-set Holiday to \"[Holiday]\"</span>")
...
/*			var/list/obj/containers = list()
			...
			message_admins("<span style='color:#0000FF'>DEBUG: Event: Egg spawned at [Egg.loc] ([Egg.x],[Egg.y],[Egg.z])</span>")*/
		if("End of the World")
