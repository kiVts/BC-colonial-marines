...
/obj/item/clothing/gloves/yautja/verb/injectors()
	...
	spawn(1200)
		if(usr && src.loc == usr)
			to_chat(usr, "<span style='color:#0000FF'>Your bracers beep faintly and inform you that a new healing crystal is ready to be created.</span>")
			inject_timer = 0

	to_chat(usr, "<span style='color:#0000FF'>You feel a faint hiss and a crystalline injector drops into your hand.</span>")
