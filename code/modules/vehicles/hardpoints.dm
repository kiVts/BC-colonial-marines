...
/obj/item/ammo_magazine/tank/ltb_cannon/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 977625)
	else
...
/obj/item/ammo_magazine/tank/autocannon/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 977625)
	else
		serial_number = given_serial
...
/obj/item/ammo_magazine/tank/ltaaap_minigun/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 977625)
	else
		serial_number = given_serial
...
/obj/item/ammo_magazine/tank/flamer/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 977625)
	else
		serial_number = given_serial
...
/obj/item/ammo_magazine/tank/towlauncher/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 977625)
	else
		serial_number = given_serial
...
/obj/item/ammo_magazine/tank/m56_cupola/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 977625)
	else
		serial_number = given_serial
...
/obj/item/ammo_magazine/tank/tank_glauncher/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 977625)
	else
		serial_number = given_serial
...
/obj/item/ammo_magazine/tank/tank_slauncher/New(turf/loc, var/given_serial = 0)
	if(given_serial == 0)
		serial_number = rand(1, 977625)
	else
		serial_number = given_serial
