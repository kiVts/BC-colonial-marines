...
/obj/machinery/vehicle_vendor/tank_vendor_ui
	...
	vendor_role = list("Vehicle Crewman") //everyone else, mind your business
...
/obj/machinery/vehicle_vendor/module_repair_station
	...
	vendor_role = list ("Vehicle Crewman", "Synthetic", "Maintenance Technician")	//Having MTs and Synthetic to have access to repair machinery seems logical thing.
	var/busy
