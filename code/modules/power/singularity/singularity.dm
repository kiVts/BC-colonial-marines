		...
		if(M.stat == CONSCIOUS)
			if (istype(M,/mob/living/carbon/human))
				...
				if(istype(H.glasses,/obj/item/clothing/glasses/meson))
					to_chat(H, "<span style='color:#0000FF'>You look directly into [src], good thing you had your protective eyewear on!</span>")
					return
		to_chat(M, "<span style='color:#FF0000'>You look directly into [src] and feel weak.</span>")
