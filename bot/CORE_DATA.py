...
channel = "#статус" #what channel you want the bot in
channels = ["#разговорна€"] #same as above
greeting = "ƒобропожаловать!" #what he says when a person he hasn't seen before joins
