...
### Update by le0p01d aka AyyChu aka ZLOI_DED (27.08.2019)

* Added GNU/Linux support (commands, bash scripts, unified strings).
* Removed trash files and code

Thanks to everyone supporting Space Station 13 and have a good shift!
